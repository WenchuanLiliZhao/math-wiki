  ...
  (() => {
    ...
    return (
      ...
      (window.$docsify.plugins = (window.$docsify.plugins || []).concat(
        function (o, t) {
          o.mounted(function () {
            const o = window.Docsify.dom.find(tocPara.pos);
            if (o) {
              const n = window.Docsify.dom.create(tocPara.element, "");
              window.Docsify.dom.toggleClass(n, "add", tocPara.className),
                window.Docsify.dom.before(o, n);
            }
          }),
            o.doneEach(function () {
              const o = window.Docsify.dom.find(`.${tocPara.className}`);
              o &&
                ((o.innerHTML = n().trim()),
                "" === o.innerHTML
